<x-app-layout>
    ...
    <div class="bg-gradient-to-r from-indigo-400 via-purple-400 to-pink-400 rounded-3xl shadow-2xl p-16 md:p-24 mb-12 text-center">
    <h1 
        class="font-extrabold tracking-wide leading-tight text-gray-900"
    ...
    >
        Welcome, {{ strtoupper(Auth::user()->name) }}
            ...
            <div class="mt-4">
                ...
                <div class="bg-white rounded-3xl shadow-lg p-8 hover:shadow-2xl transition" style="display: flex; flex-direction: :row;">
